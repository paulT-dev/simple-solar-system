# NeptuneKeplerOrbit.gd
extends Node3D

@export var AU_UNITS: float = 30.0			# 1 AU = 30 Units
@export var a_au: float = 30.07				# große Halbachse (AU)
@export var e: float = 0.00868				# Exzentrizität
@export var i_deg: float = 1.769			# Inklination (°)
@export var Omega_deg: float = 131.784		# Länge aufst. Knoten (°)
@export var omega_deg: float = 273.187		# Argument des Perihels (°)

@export var days_per_orbit: float = 60190.0	# siderische Umlaufzeit (Tage)
