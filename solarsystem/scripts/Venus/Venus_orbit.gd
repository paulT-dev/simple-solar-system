...
@export var Omega_deg: float = 76.680		# Länge des aufst. Knotens (°)
@export var omega_deg: float = 54.884		# Argument des Perihels (°)

@export var days_per_orbit: float = 224.701	# siderische Umlaufzeit (Tage)
