# CallistoSpin.gd — Eigenrotation (optional: Tidal-Lock zu Jupiter)
extends Node3D

@export var center_body: NodePath				# Jupiter (für Tidal-Lock)
@export var days_per_turn: float = 16.689018	# synchron zur Umlaufzeit
@export var axial_tilt_deg: float = 0.1
