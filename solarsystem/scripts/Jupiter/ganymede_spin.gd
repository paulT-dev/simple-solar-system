# GanymedeSpin.gd — Eigenrotation (optional: Tidal-Lock zu Jupiter)
extends Node3D

@export var center_body: NodePath				# Jupiter (für Tidal-Lock)
@export var days_per_turn: float = 7.154553	# synchron zur Umlaufzeit
@export var axial_tilt_deg: float = 0.1			# sehr kleine Neigung (Demo)
