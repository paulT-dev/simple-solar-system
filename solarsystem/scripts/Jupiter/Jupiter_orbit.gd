# JupiterKeplerOrbit.gd — elliptische Bahn um (0,0,0)
extends Node3D

@export var AU_UNITS: float = 30.0
@export var a_au: float = 5.2044
@export var e: float = 0.0489
@export var i_deg: float = 1.304
@export var Omega_deg: float = 100.556
