# GanymedeKeplerOrbit.gd — elliptische Bahn RELATIV zu Jupiter
extends Node3D
...
# Bahndaten (nahe J2000, ekliptikbezogen; für Demo ausreichend)
@export var a_au: float = 0.007155				# ~1,070,400 km
@export var e: float = 0.0013
@export var i_deg: float = 0.177
@export var Omega_deg: float = 0.0
@export var omega_deg: float = 0.0

@export var days_per_orbit: float = 7.154553	# siderische Umlaufzeit (Tage)
