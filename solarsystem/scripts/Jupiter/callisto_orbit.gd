# CallistoKeplerOrbit.gd — elliptische Bahn RELATIV zu Jupiter
extends Node3D
...
# Bahndaten (nahe J2000, ekliptikbezogen – bei Bedarf feintunen)
@export var a_au: float = 0.01259				# ~1,882,700 km
@export var e: float = 0.0074
@export var i_deg: float = 0.192
@export var Omega_deg: float = 0.0
@export var omega_deg: float = 0.0

@export var days_per_orbit: float = 16.689018	# siderische Umlaufzeit (Tage)
