...
@export var a_au: float = 19.2184
@export var e: float = 0.04638
@export var i_deg: float = 0.773
@export var Omega_deg: float = 74.006
@export var omega_deg: float = 96.999

@export var days_per_orbit: float = 30688.5
