...
@export var a_au: float = 9.537				# große Halbachse (AU)
@export var e: float = 0.054				# Exzentrizität
@export var i_deg: float = 2.485			# Inklination (°)
@export var Omega_deg: float = 113.665		# Länge aufst. Knoten (°)
@export var omega_deg: float = 339.392		# Argument des Perihels (°)

@export var days_per_orbit: float = 10759.22	# ~29.46 Jahre in Tagen
